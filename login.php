                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    ?>
                                    <form class="row g-3 needs-validation" action="./include/autentification.php" method="POST" novalidate>
                                    
                                    <div class="input-group has-validation" id="div-input">
                                        <span class="input-group-text" id="inputGroupPrepend">@</span>
                                        <input type="text" class="form-control" id="validationCustomUsername" aria-describedby="inputGroupPrepend" placeholder="Username or Email address :" value="<?=$name?>" name="username_user" required>
