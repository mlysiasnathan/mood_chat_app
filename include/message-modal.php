...
<!-- Message Modal-->
    <div class="modal fade" id="messageModal<?=$conversation['user_id']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content" style="border-radius: 15px;">
                <div class="modal-header" id="modal-header">
<!-- Profil receiver Modal-->
                    <a class="nav-link collapsed" href="#">
                        <img class="img-profile rounded-circle" src="./upload/<?=$conversation['img']?>" style="height: 50px;width: 50px;">
                        <span class="mr-2 text-white"><?=$conversation['names']?></span>
                        <?php
                        ...
                        <?Php }else{?>
                            <span class="mr-2 p-1 rounded text-danger text-xs bg-warning"><?=$conversation['last_seen']?></span>
                        <?php } ?>
