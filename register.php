...
<!-- Error alerte -->
                                    ...
                                    <form class="row g-3 needs-validation" action="./include/sign_in.php" method="POST" novalidate>
                                        ...
                                        <div class="input-group has-validation" id="div-input">
                                            ...
                                            <input type="text" class="form-control" id="validationCustomUsername" aria-describedby="inputGroupPrepend" value="<?=$name?>" placeholder="Usernames :" name="username_user"  required>
                                        </div>


                                        <div class="input-group has-validation mt-2" id="div-input">
                                                <span class="input-group-text" id="inputGroupPrepend">@</span>
                                                <input type="email" class="form-control" id="validationCustomUsername" aria-describedby="inputGroupPrepend" value="<?=$email?>" placeholder="Email address :" name="email_user"  required>
                                        </div>


                                        <div class="input-group has-validation mt-2" id="div-input">
                                            <span class="input-group-text" id="inputGroupPrepend"><i class="fa fa-calendar"></i></span>
                                            <input  type="date" class="form-control" id="validationCustomUsername" aria-describedby="inputGroupPrepend" value="<?=$bday?>" placeholder="Birth day :" name="bd_user"  required>
                                        </div>
